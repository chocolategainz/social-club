...
export default function Home() {
  return (
    <div className="home">
      ...
      {/* Good Vibes */}
      <div className="flex flex-wrap gap-4 sm:gap-6 flex-col sm:flex-row mt-8 px-2 sm:px-4">
        <Image
          ...
          width={420}
          height={420}
          className="rounded-full object-cover aspect-square w-full max-w-[420px] sm:w-auto"
        />
      ...
      {/* Togetherness */}
      <div className="flex gap-5 items-center mt-4 sm:mt-8">
        <Image
      ...
      <div className="secondaryPicture relative w-full h-[600px] aspect-[16/9]">
        ...
        />
        <div className="rsvp absolute inset-0 flex flex-col items-center justify-center text-center px-4 md:px-6">
          <h1 className="overlayTitle absolute bottom-[40%] md:bottom-[60%] text-white">RSVP</h1>
          <p className="overlayText text-white md:top-[50%] text-sm sm:text-base sm:max-w-sm md:text-lg lg:text-xl max-w-sm md:max-w-md lg:max-w-lg px-4">
            Your +1s and +2s are always welcome! Just let us know in advance so we can make sure there's enough drinks for everyone.
          </p>
        </div>
        <Modal />
      </div>
